    ...
    <footer className="bg-secondary text-secondary-foreground py-8">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-heading text-xl mb-4">Семейные корни</h3>
          ...
          <div>
            ...
            <p className="text-secondary-foreground/80 mb-2">Электронная почта: info@semeynyekorni.ru</p>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="hover:text-accent transition-colors" aria-label="WhatsApp">
                💬
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-secondary-foreground/20 mt-8 pt-6 text-center text-secondary-foreground/60">
          <p>Сайт подготовлен Рябых Н.Б. для презентации на конкурсе.</p>
        </div>
      </div>
    </footer>
  );
